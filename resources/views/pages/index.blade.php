...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                   <h2 class="text-monospacese navbar-brand"> Tanvir Hossain</h2>
        ...
        <header class="masthead" style="background-image: url(<?php echo $main->bc_img ?> )">
            <div class="container">
                <div class="timeline-image"><img class="rounded-circle  img-thumbnail" style="height: 50vh " src="assets/img/Tanvir1.jpg" alt="" /></div><br> <br>

                <div class="masthead-heading text-uppercase text-warning">{{$main->title}} <br>
                    <div class="masthead-subheading text-light ">{{$main->sub_title}}</div>
                </div>


                <div>
                    <br> <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{url($main->resume)}}">Resume</a>
                </div>
            </div>
        </header>
        <!-- Services-->
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            <div class="portfolio-item">
                                <a class="portfolio-link" data-toggle="modal" href="#portfolioModal<?php echo $portfolio->id ?>">
                                    ...
                                    <img  class="img-fluid" src="{{url($portfolio->small_image)}}"/>
                                </a>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright © All Right Reserved Tanvir Hossain</div>
